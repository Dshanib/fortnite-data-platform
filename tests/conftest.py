...
def _test_env(monkeypatch: pytest.MonkeyPatch, tmp_path) -> None:
    ...
    env = {
        ...
        "FORTNITE_ECOSYSTEM_MAX_ISLAND_PAGES": "15",
        "FORTNITE_ECOSYSTEM_CATALOG_MAX_PAGES": "50",
        "FORTNITE_ECOSYSTEM_CATALOG_PAGE_DELAY_SECONDS": "0",
        "FORTNITE_ECOSYSTEM_METRICS_DELAY_SECONDS": "0",
        "FORTNITE_MAX_ISLANDS": "0",
        "FORTNITE_MAX_MESSAGES_PER_TOPIC": "5000",
